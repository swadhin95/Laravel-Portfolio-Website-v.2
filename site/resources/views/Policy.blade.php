...
<div class="container-fluid jumbotron mt-5 " id="jumbotronID">
    <div class="row d-flex justify-content-center">
        ...
        <ul>
            <li>After tutorial account activation money back is not available.
            </li>
            ...
            <li>To serve you and others better in the future, we require that you tell us why you want a refund and provide us with an opportunity to help you fix the issue. We want satisfied customers.
